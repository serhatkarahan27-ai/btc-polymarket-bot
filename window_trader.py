...
CONFIG = {
    ...
    "limit_price": 0.50,           # bu fiyat veya altinda al
    "max_fill_wait_secs": 300,     # max 5dk fill bekleme
    "fill_check_interval": 1,     # her 1sn'de fiyat kontrol
    "max_spread_pct": 10.0,        # max spread % (up+down-1.0)
    "min_entry_price": 0.35,       # bunun altinda girilmez
    "max_entry_price": 0.60,       # bunun uzerinde girilmez
    "min_momentum_pct": 0.05,      # minimum momentum % (altinda skip)
}
